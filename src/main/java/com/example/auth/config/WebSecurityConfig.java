...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                // 2. permitAll(), authenticated() 등을 통해
                //      어떤 사용자가 접근 가능한지 설정
                .authorizeHttpRequests(authHttp -> // HTTP 요청 허가 관련 설정을 하고싶다
                ...
                .logout(
                        logout -> logout
                                // 로그아웃을 요청을 보낼 url
                                // 어떤 UI 에 로그아웃 기능을 연결하고 싶으면
                                // 해당 UI 가 /users/logout 으로 POST 요청을
                                // 보내게끔한다
